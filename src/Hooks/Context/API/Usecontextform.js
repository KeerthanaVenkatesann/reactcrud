...
import { useGlobalContext } from "../../../Hooks/Context/API/Contextstate";
...
// eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  return (
    <div className=" d-flex justify-content-center flex-column bgs " id="pics">
        <div className=" d-flex justify-content-start mt-3 ms-5">
        <Link to="/Usecontextlist">
          <button className="btn bg-primary text-light bg-opacity-75 ">
            {" "}
            Back
          </button>
        </Link>
    ...
    <div className="container col-md-8 card shadow" id="cove">
    <Form className="form">
          {/* <div className="d-flex justify-content-start">
            <Link to="/Usecontextlist">
              <Button className="rounded-pill mt-4" variant="dark">
           ...
           <div className="row  ">
          <h1 className="text-center  p-2 shadow-sm   bg-dark text-light bg-opacity-75 ">
          ...
          <div className="d-flex justify-content-center">
            <div className="">
              <Button className="m-3 btn text-light bg-primary rounded " onClick={handleSubmit}>
                {id ? "Update" : "Submit"}
              </Button>
            </div>
          </div></div>
